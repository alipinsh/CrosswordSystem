...
return [
    ...
    'password' => 'Пароль',
    'passwordAgain' => 'Повторить пароль',
    ...
    'newPasswordAgain' => 'Повторить новый пароль',
    ...
    'changeEmailInfo' => 'Если вы измените этот адрес, мы отправим вам письмо на ваш новый адрес для подтверждения',
    'newEmail' => 'Новый адрес электронной почты',
    'pendingEmail' => 'Ожидается новый адрес электронной почты (проверьте свой e-mail для подтверждения)',
    'confirmEmail' => 'Подтвердите свой адрес электронной почты',
    'emailUpdateRequest' => 'Запрос на обновление адреса электронной почты',
    'changePassword' => 'Изменить пароль',
    'currentPassword' => 'Текущий пароль',
    'update' => 'Обновить',
    'deleteAccount' => 'Удалить аккаунт',
    'deleteAccountInfo' => 'Будьте осторожны, это действие нельзя отменить!',
    'areYouSure' => 'Вы уверены?',

    // Error and success
    'passwordMismatch' => 'Пароли должны совпадать!',
    'registrationSuccess' => 'Успех! Пожалуйста, активируйте свой аккаунт, нажав на ссылку активации в письме, которое мы отправили!',
    ...
    'createdCrosswords' => 'Созданные кроссворды',
    'favoritedCrosswords' => 'Избранные кроссворды',
    'imageInfo' => 'Изображение должно быть в формате png, gif или jpeg. Размер не может быть 256 кб или больше.',
