...
return [
    ...
    'newPasswordAgain' => "Vēlreiz jauna parole",
    'passwordResetRequest' => "Paroles atjaunošanas pieprasījums",

    // Account
    'account' => 'Konts',
    'accountSettings' => "Konta iestatījumi",
    'changeEmail' => 'Mainīt e-pasta adresi',
    'changeEmailInfo' => 'Ja to mainīsiet, mēs jums nosūtīsim e-pastu uz jauno adresi, lai to apstiprinātu.',
    'newEmail' => 'Jauna e-pasta adrese',
    'pendingEmail' => 'Gaidāmā jaunā e-pasta adrese (pārbaudiet savu e-pastu, lai to apstiprinātu)',
    'confirmEmail' => "Apstipriniet savu e-pasta adresi",
    "emailUpdateRequest" => "E-pasta adreses atjaunināšanas pieprasījums",
    "changePassword" => "Mainīt paroli",
    "currentPassword" => "Pašreizējā parole",
    "update" => "Atjaunināt",
    "deleteAccount" => "Dzēst kontu",
    "deleteAccountInfo" => "Uzmanīgi, šo darbību nevar atcelt!",
    ...
    'emailUpdateStarted' => 'Veiksmīgs! Lūdzu, pārbaudiet savu jauno adresi, noklikšķinot uz saites mūsu nosūtītajā e-pastā!"',
    'confirmEmailSuccess' => 'Apstiprināšana ir veiksmīga! Jūsu jaunā e-pasta adrese tagad ir aktīva.',
    'passwordUpdateSuccess' => 'Parole ir veiksmīgi atjaunināta!',
    'wrongEmail' => 'Nepareiza e-pasta adrese!',
